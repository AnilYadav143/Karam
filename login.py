...
<!--menubar ends here-->
<br/>
<!--For form image and form added-->

<div class="logdiv">
<div class="box">
<center>
<h1>Login Here</h1>
<table style="height:250px;width:70%;margin-top:20px;">
<form action="logcode.py" method="post">
<tr>
<td><font size="5px">Email:</font></td>
<td><input type="email" name="email" placeholder="Enter Email Id" style="height:35px;width:300px;"/></td>
</tr>
<tr>
<td><font  size="5px">Password:</font></td>
<td><input type="password" name="password" placeholder="Enter Password" style="height:35px;width:300px;"/></td>
</tr>
<tr>
<td colspan="2" align="center"><input type="submit"/></td>
<td><a href="admin/index.html">admin login</a></td>
</tr></form>
</table>
</center>
</div>
</div>
<!-- End For form:image and form added-->
<br/>
<br/>
