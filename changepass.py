...
<br/>
 <div class="bb">
   <center><h1 style="color=red;box-shadow:3px 3px 6px green;text-shadow:3px 3px 5px orange;">Change Password</h1>
   <form action="cpcode.py" method="post" style="box-shadow:5px 5px 9px #99d1ff;">
